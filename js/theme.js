	...
	var spCustom = {
		...
		bindEvents : function() {
			...
			self.config.$document.on( 'ready', function() {
				...
				// User modal switcher
				$('#signup-alternative').click( function( event ) {
					$('#signin-modal').modal('toggle');
				});

				$('#signin-alternative').click( function( event ) {
				...
				// Guest picker
				$('.guest-picker-trigger').on( 'click', function( event ) {
					event.preventDefault();
					toggleGuest();
				...
				function toggleGuest(bool) {
					...
					if ( guestTypeIsOpen ) {
						$('.guest-picker-wrapper').removeClass('guest-open');
					} else {
						$('.guest-picker-wrapper').addClass('guest-open');
					}
				}
